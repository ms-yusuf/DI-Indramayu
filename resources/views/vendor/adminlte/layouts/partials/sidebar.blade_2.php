...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			...
			<!-- <li {{{ (Request::is('peta') ? 'class=active' : '') }}}>
			<a href="{{ url('/peta') }}"><i class='glyphicon glyphicon-globe'></i> <span>Peta</span></a>
			</li> -->
			...
			<ul data-widget="tree">
			  ...
			  <li><a href="{{ url('/pembuang') }}">Bangunan Bedung</a></li>
			  <li><a href="{{ url('/bangunan') }}">Bangunan Bagi / Sadap</a></li>
			  <li><a href="{{ url('/bangunan') }}">Bangunan Lain</a></li>
			  <!--<li class="treeview">
				<a href="#">Multilevel</a>
